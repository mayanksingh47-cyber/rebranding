...
class DXCLogoRebrander:
    ...
    def _replace_purple_colors_in_image(self, img: Image.Image) -> Image.Image:
        """
        Replace ALL purple colors (text, headings, shapes, borders, icons) with orange (#EF8900).
        AGGRESSIVE: Catches ALL purple shades including light, dark, and gradient purples.
        Uses FAST vectorized NumPy operations to convert EVERY purple pixel to orange.
        """
        ...
        # Replace ALL purple with orange (#EF8900 = RGB 239, 137, 0)
    ...
    def rebrand_pdf(self, source_file: bytes, source_filename: str) -> Tuple[bytes, str]:
        ...
        - Convert purple colors to orange
        ...
        try:
            ...
            for img in page_images:
                ...
                # Step 2: Replace purple colors/text with orange
    ...
    if uploaded_files:
        ...
        if process_btn:
            ...
            with st.spinner("Processing documents..."):
                results = st.session_state.logo_rebrander.process_files(uploaded_files)
